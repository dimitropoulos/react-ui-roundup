...
********************************************************************************
-->
> all of the above statistics were last updated Thu, 28 Oct 2021 21:32:09 GMT.  For real-time data, [see the website](http://react-ui-roundup.dimitrimitropoulos.com).
...
- `API`: The API style used for the components contained within the App Bar.
...
- `Theme Mode`: The bar can be individually themed to use a theme mode that doesn't match the rest of the app.  E.g. dark mode app bar in a light mode app.
